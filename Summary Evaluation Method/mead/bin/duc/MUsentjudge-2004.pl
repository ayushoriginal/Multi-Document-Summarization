...
#### For DUC 2004 ####
my $docsentDir = "/clair8/projects/duc04/duc04data/test-data/task1-2/t1.2/docs/$cluster/docsent";
# my $docsentDir = "/clair8/projects/ru/clusters/duc04/$cluster/docsent";
my $modelunitDir = "/clair8/projects/ru/clusters/duc04/models/$task";
my $MUsentjudgeDir = "/clair8/projects/ru/clusters/duc04/sentjudge";

my $clusterFile = "$docsentDir/../$cluster.cluster";
