function output = divrank_accumulate(W, lambda_value, alpha_value, r)
%% Input arguments:
...
% for i = 1:1000
    W1 = alpha_value * W0 .* repmat(pr_pastall, n, 1);
    W1 = W1 - diag(diag(W1)) + (1 - alpha_value) * diag(pr_pastall);
    tmp1 = sum(W1, 2);
%     idx_nan = find(tmp1 == 0);
